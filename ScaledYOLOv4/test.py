...
def test(data,
    ...
    if save_json and len(jdict):
        ...
        try:  # https://github.com/cocodataset/cocoapi/blob/master/PythonAPI/pycocoEvalDemo.ipynb
            ...
            cocoGt = COCO(glob.glob('/workspace/dataset/coco2017/annotations/instances_val*.json')[0])  # initialize COCO ground truth api
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/vtt19.yaml', help='*.data path')
