...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='runs/exp4/weights/last.pt', help='initial weights path')
    # parser.add_argument('--weights', type=str, default='weight/yolov4-p5.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='models/yolov4-p5-19.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/vtt-coco.yaml', help='data.yaml path')
